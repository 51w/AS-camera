...
public class GLProgram {
     ...
     */
    public void buildTextures(Buffer y, Buffer uv, int type, int yHorizontalStride, int uvHorizontalStride, int verticalStride) {
        ...
        Log.d(TAG, "buildTextures: yHorizontalStride=" + yHorizontalStride);
     ...
     */
    public void drawFrame(int orderVU, int type) {
